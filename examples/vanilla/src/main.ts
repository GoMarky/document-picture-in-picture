...
// DOM Elements
const supportStatus = document.getElementById('supportStatus') as HTMLElement;
const supportText = document.getElementById('supportText') as HTMLElement;
const openStatus = document.getElementById('openStatus') as HTMLElement;
const openText = document.getElementById('openText') as HTMLElement;
...
const pipContent = document.getElementById('pipContent') as HTMLElement;
const currentTimeEl = document.getElementById('currentTime') as HTMLElement;
const notSupported = document.getElementById('notSupported') as HTMLElement;
